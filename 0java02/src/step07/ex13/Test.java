...
public class Test {
  public static void main(String[] args) {
    ...
    //문제는 코드를 해석하기가 어렵다는 것이다. => 해결책: 상수
    //s.grade = 1; //고졸(1), 전문학사(2), 3학년학사(3), 4년학사(4), 석사(5), 박사(6)
    s.grade = Student.MASTOR; //위 코드처럼 숫자를 넣는 것 보다 이해하기 쉽
    ...
    // => Generallization 해서 만든 수퍼 클래스는 보통 직접 사용할 일이 없기 때문에,
    //    추상 클래스로 만든다.
