 ...
 * 주제 : 자바 핵심 클래스 - Object
 * => 최상위 클래스. root class
 * => 자바 모든 클래스의 조상이다. => 모든 자바 클래스는 Object 클래스의 메서드를 상속 받았다.
 * => 무조건 상속 받는다.
 * => 클래스가 받드시 가져야할 기본 기능을 정의하고 있다.
 ...
 *    finalize(): 가비지 컬렉터가 소멸 시키기 전에 호출되는 메서드.
 *                즉, 객체의 마무리할 기회를 주는 것이다.
 */
package step06;
...
public class Exam06 /* extends Object */{
  ...
  public static void main(String[] args) {
    //1) Object의 직접적인 인스턴스 이거나 또는 자손인지 알아내기
