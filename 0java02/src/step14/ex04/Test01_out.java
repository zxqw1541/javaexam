...
public class Test01_out {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //write(int)
    // => 마지막 2 바이트를 읽어서 JVM 기본 문자집합으로 인코딩 한다.
    ...
    // FileOutputStream의 writer는 자동으로 인코딩하지 않았다.
    // FileWriter는 문자 출력을 다루는 도구라서 자동으로 UTF-8로 인코딩한다.
    // (물론, JVM의 기본 문자집합이 UTF-8이라고 가정 하자.)
    // (JVM의 기본 문자집합이 MS949면 당연히 유니코드를 MS949로 인코딩할 것이다.)
    
    //write(char[])
    //char[] chars = new char[]{'H', 'e', 'l', 'l', 'o'};
    char[] chars = {'H', 'e', 'l', 'l', 'o', '똘', '똠', '똥'};
