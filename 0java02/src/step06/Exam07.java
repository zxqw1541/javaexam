...
public class Exam07 /* extends Object */{
  ...
  public static void main(String[] args) {
    ...
    String str = s1.toString(); // Object로 부터 상속받은 메서드 호출!
    System.out.println(str);
    System.out.println(s2.toString());
    
    //2) hashCode(): 식별번호만 리턴한다.
    //   => 식별번호? 인스턴스의 내용을 구분하는 값이다.
    //   => Object에서 상속 받은 날 것의 hashCode()는 인스턴스 내용에 상관 없이
    ...
    // 이유? Object로 부터 상속받은 toString()을 재정의 했기 때문이다.
    ...
    // StringBuffer는 Object로 부터 상속 받은 메서드를 재정의 했고, 
    // Student는 재정의 하지 않았다.
    // 그래서 Student에 대해 toString을 호출하면 "클래스정보@식별번호" 문자열을 출력한다.
    // overriding, overload 정리할 것
  }
}
