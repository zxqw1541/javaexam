...
public class Test2 {
  ...
  public static void main(String[] args) {
    ...
    p3.test1(); // 당연히 OK!
    p3.test2(); // B의 test2()호출할 때 B의 변수가 없기 때문에 오류 발생!
    p3.test4(); // D의 test4()호출할 때 D의 변수가 없기 때문에 오류 발생!
    */
    //=> 그래서 레퍼런스 변수는 
    //   항상 자신보다 적은 기능을 가진 상위 클래스의 인스턴스를 가리킬수 없다.
