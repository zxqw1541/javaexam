...
import v10.server.exception.DaoException;



// 데이터의 지속성(persistence)을 관리
// => 등록(Create), 조회(Read/Retrieve), 변경(Update), 삭제(Delete)을 관리
// => 이런 기능을 CRUD 라고 부른다.
public class StudentDao {
  ...
  public void save() {
    ...
    try (FileWriter out = new FileWriter("./data/student.dat");
