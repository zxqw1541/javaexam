...
<tr>
  <th>첨부파일</th>
  <td><a href='../attachfile/${board.a_file}'>${board.a_file}</a><br>
  <input type="file" name='file'>
  <input hidden='text' name='a_file' value='${board.a_file}'>
  </td>
...
function deleteBoard() {
  ...
  var href = document.getElementById('aDelete').href + "&password=" + password;
