...
public class Test {
  public static void main(String[] args) {
    ...
    // 인스턴스 value 변수는 preotected로 보호되기 때문에 다른 패키지에서는 직접 접근할 수 없다.
