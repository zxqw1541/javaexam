...
public class Exam15 {
  ...
  public static void main(String[] args) {
    ...
    Date today = new Date();
    System.out.println(today.getYear() + 1900); //1900년 기준
    System.out.println(today.getMonth() + 1); //0부터시작
    System.out.println(today.getDate());
    System.out.println(today.getDay()); // 0부터 시작
