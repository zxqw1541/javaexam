...
public class Servlet02 extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
    ...
    out.printf("httpReq.getHeader(User-Agent): %s\n", httpReq.getHeader("User-Agent"));

    // 요청 예)
    // http://192.168.0.36:8080/0web01/step05/servlet02?name=okok&page=20
    //
    // 결과
    /*
     * ServletRequest를 통해 뽑아내는 정보: 
     * 클라이언트 IP = 192.168.0.36 
     * 클라이언트 이름 = 192.168.0.36 
     * 클라이언트 포트 = 24349 
     * 프로토콜 이름 = http 
     * HttpServletRequest를 통해 뽑아내는 정보: 
     * getMethod(): GET 
     * getContextPath(): /0web01 
     * getPathInfo(): null
     * getQueryString(): 
     * name=okok&page=20 
     * getRequestURI(): /0web01/step05/servlet02 
     * getRequestURL(): http://192.168.0.36:8080/0web01/step05/servlet02 
