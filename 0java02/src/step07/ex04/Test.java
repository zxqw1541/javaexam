...
public class Test {
  ...
  public static void main(String[] args) {
    ...
    c1.plus(10); // c1 레퍼런스에 들어있느 주소는 plus()를 호출할 때 this에 저장된다.
    c2.plus(8); // c2 레퍼런스에 들어있느 주소는 plus()를 호출할 때 this에 저장된다.
    // 표현!
    // 1) c1에 들어있는 주소를 줄테니 그 주소에 인스턴스를 사용하여 plus()작업을 수행하라.
